...
public interface ProductRepository extends JpaRepository<Product, UUID> {
       ...
       /**
        * Busca produtos de uma categoria ordenados por displayOrder (valores menores
        * primeiro)
        * Produtos sem displayOrder aparecem por último
        */
       ...
       /**
        * Busca produtos disponíveis da loja ordenados por displayOrder (valores
        * menores primeiro)
        * Produtos sem displayOrder aparecem por último
       ...
       /**
        * Busca produtos disponíveis de uma categoria ordenados por displayOrder
       ...
       @Modifying
       @Query("UPDATE Product p SET p.category = NULL WHERE p.category = :category AND p.deletedAt IS NULL")
       void detachCategoryFromProducts(@Param("category") Category category);
}
